...
package com.agentfactory.cldc.migcomp;
...
public class MigrationCompiler {
	...
	static void compile(String fileName, ClassLoader loader, String mode,
			Collection<String> coll) throws IOException {
		...
		while ((line = reader.readLine()) != null) {
			...
			if (command.equals("MROLE"))
				compile(string[i + 1], loader, mode, coll);
