...
/** Creates an instance of the dual migrate actuator using the affect manager for
 * the agent.
 *
 * @author Conor Muldoon
 */
public class DualMigrateFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new DualMigrate(manager);
    }
