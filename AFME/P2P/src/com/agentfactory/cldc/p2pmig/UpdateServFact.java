...
/** Creates an instance of the update server actuator using the affect manager for the
 * agent.
 *
 * @author Conor Muldoon
 */
public class UpdateServFact implements ActuatorFactory{
