...
/** Creates an instance of the lookup platform actuator using the affect manager for the
 * agent.
 *
 * @author Conor Muldoon
 */
public class LookupPlatFact implements ActuatorFactory{
