...
/** Creates an instance of the peer to peer request actuator using the specified 
 * affect manager. It should be noted that factories are 
 * only required within the migration process.
 *
 * @author Conor Muldoon
 */
public class P2PRequestFact implements ActuatorFactory{
