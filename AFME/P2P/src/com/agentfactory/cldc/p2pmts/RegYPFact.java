...
/** Creates an instance of the register yellow pages actuator using the affect manager for the
 * agent.
 *
 * @author Conor Muldoon
 */
public class RegYPFact implements ActuatorFactory{
