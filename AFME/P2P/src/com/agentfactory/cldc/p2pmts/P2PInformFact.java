...
/** Creates an instance of the peer to peer inform actuator using the specified affect manager.
 *
 * @author Conor Muldoon
 */
public class P2PInformFact implements ActuatorFactory{
