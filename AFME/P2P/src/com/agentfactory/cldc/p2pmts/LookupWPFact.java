...
/** Creates an instance of the lookup white pages actuator using the affect manager for the
 * agent.
 *
 * @author Conor Muldoon
 */
public class LookupWPFact implements ActuatorFactory{
