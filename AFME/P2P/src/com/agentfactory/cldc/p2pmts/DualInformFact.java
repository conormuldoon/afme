...
/** Creates an instance of the dual inform actuator using the specified affect manager.
 *
 * @author Conor Muldoon
 */
public class DualInformFact implements ActuatorFactory{
