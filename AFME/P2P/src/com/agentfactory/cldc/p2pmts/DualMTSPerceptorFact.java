...
/** Creates an instance of the DualMTSPerceptor using the specified perception
 * manager. It should be noted that factory classes are only required when migration is being used.
 *
 * @author Conor Muldoon
 */
public class DualMTSPerceptorFact implements PerceptorFactory{
    ...
    public Perceptor createPerceptor(PerceptionManager manager){
        return new DualMTSPerceptor(manager);
    }
