 ...
 */
 ...
 /*
 * AddAgentIDFactory.java
 *
 * Created on 11 July 2005, 14:55
 */
...
/** Creates an instance of DualIDActuator using the specified affect manager.
 *
 * @author Conor Muldoon
 */
public class DualIDActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new DualIDActuator(manager);
    }
