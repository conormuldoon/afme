...
/** The CDC peer to peer migration manager is a service that is responsible for controlling the
 ...
 * firewalls. With CDC the peer to peer migration service, agents migrate
...
public class CDCP2PMigrationManager extends Service implements Runnable{
    ...
    Scheduler sched;
    boolean scheduled;
    /** Creates a new instance of CDCP2PMigrationService.
     * 
    ...
    public CDCP2PMigrationManager(String[]s,AgentName[]an,Scheduler scheduler,MigrationPlatform platform)   { 
    super(s[0]);
        ...
        sched=scheduler;
        new CDCServerThread(s,platform).start();
    }
    /*
     *  (non-Javadoc)
