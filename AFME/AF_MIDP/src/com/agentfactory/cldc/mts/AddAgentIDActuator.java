...
/** Adds an agent id to the address list of the agent. The trigger for
 * this actuator is addAgentID(?name,?addresses). The ?name variable
 * is the name of the agent to be added. The ?addresses variable represents
 * the address of the agent to be added.
 * 
 * @author Conor Muldoon
 */
public class AddAgentIDActuator extends Actuator {
     ...
     */
    public AddAgentIDActuator(AffectManager manager) {
