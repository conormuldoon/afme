...
/** This actuator enables an agent to make a request to another agent.
 ...
 */
public class RequestActuator extends Actuator {
     ...
     * @param manager
     */
    public RequestActuator(AffectManager manager) {
