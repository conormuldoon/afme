...
/** Creates an instance of the migrate actuator using the affect manager for
 * the agent.
 *
 * @author Conor Muldoon
 */
public class MigrateActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new MigrateActuator(manager);
    }
