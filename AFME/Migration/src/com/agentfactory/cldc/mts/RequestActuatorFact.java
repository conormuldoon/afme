...
/** Creates an instance of the request actuator using the specified 
 * affect manager. It should be noted that factories are 
 * only required within the migration process.
 *
 * @author Conor Muldoon
 */
public class RequestActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new RequestActuator(manager);
    }
