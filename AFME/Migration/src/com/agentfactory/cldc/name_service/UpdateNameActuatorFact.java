 ...
 */
 ...
 /*
 * UniqueNameFactory.java
 *
 * Created on 11 July 2005, 15:13
 */
...
/** Factory class used in the migration process to create an UpdateNameActuator.
 *
 * @author Conor Muldoon
 */
public class UpdateNameActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new UpdateNameActuator(manager);
    }
