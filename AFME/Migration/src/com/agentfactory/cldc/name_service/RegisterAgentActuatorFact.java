...
/*
 * RegisterAgentFactory.java
 *
 * Created on 11 July 2005, 15:17
 */
...
/** Creates an instance of RegisterAgentActuator using the specified affect manager.
 *
 * @author Conor Muldoon
 */
public class RegisterAgentActuatorFact implements ActuatorFactory{
	/*
	 *  (non-Javadoc)
    ...
    public Actuator createActuator(AffectManager manager){
        return new RegisterAgentActuator(manager);
    }
