 ...
 */
 ...
 /*
 * LocalNameFactory.java
 *
 * Created on 11 July 2005, 15:02
 */
...
/** Creates an instance of LocalNameActuator using the specified affect manager.
 *
 * @author Conor Muldoon
 */
public class LocalNameActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new LocalNameActuator(manager);
    }
