...
/** Factory class used in the migration process to create a UniqueNameActuator.
 *
 * @author Conor Muldoon
 */
public class UniqueNameActuatorFact implements ActuatorFactory{
    ...
    public Actuator createActuator(AffectManager manager){
        return new UniqueNameActuator(manager);
    }
